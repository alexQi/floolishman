...
func (s *Test) OnCandle(option *model.PairOption, df *model.Dataframe) model.PositionStrategy {
	...
	if prevRsi > 70 {
		...
		if prevRsi >= 74 && prevRsi < 80 && lastRsiChange > 9.4 {
			if prevAmplitude < 1.2 {
				if upperShadowChangeRate > 0.6 {
					distanceRate = 0.195
				...
				if upperShadowChangeRate > 0.38 {
					distanceRate = 0.175
					strategyPosition.Useable = 1
				}
			} else {
				if upperShadowChangeRate > 0.30 {
					distanceRate = 0.165
					strategyPosition.Useable = 1
		...
		if prevRsi >= 80 && prevRsi < 86 && lastRsiChange > 7.6 {
			if prevAmplitude < 1.2 {
				if upperShadowChangeRate > 0.72 {
					distanceRate = 0.155
					strategyPosition.Useable = 1
				}
			} else if prevAmplitude > 1.2 && prevAmplitude < 2.1 {
				if upperShadowChangeRate > 0.66 {
					distanceRate = 0.145
					strategyPosition.Useable = 1
				}
			} else if prevAmplitude > 2.1 && prevAmplitude < 4.0 {
				if upperShadowChangeRate > 0.60 {
					distanceRate = 0.135
					strategyPosition.Useable = 1
				}
			} else {
		...
		if prevRsi >= 86 && prevRsi < 92 && lastRsiChange > 5.8 {
			if prevAmplitude < 1.2 {
				if upperShadowChangeRate > 0.72 {
					distanceRate = 0.115
					strategyPosition.Useable = 1
	...
	if prevRsi < 30 {
		...
		if prevRsi >= 20 && prevRsi < 26 && lastRsiChange > 9.4 {
			if prevAmplitude < 1.2 {
				if lowerShadowChangeRate > 0.8 {
					distanceRate = 0.195
					strategyPosition.Useable = 1
				}
			} else if prevAmplitude > 1.2 && prevAmplitude < 2.1 {
				if lowerShadowChangeRate > 0.75 {
					distanceRate = 0.185
					strategyPosition.Useable = 1
				}
			} else if prevAmplitude > 2.1 && prevAmplitude < 4.0 {
				if lowerShadowChangeRate > 0.7 {
					distanceRate = 0.175
					strategyPosition.Useable = 1
				}
			} else {
				if lowerShadowChangeRate > 0.65 {
					distanceRate = 0.165
					strategyPosition.Useable = 1
				}
			}
		}
		if prevRsi >= 14 && prevRsi < 20 && lastRsiChange > 7.6 {
			if prevAmplitude < 1.2 {
				if lowerShadowChangeRate > 0.7 {
					distanceRate = 0.155
					strategyPosition.Useable = 1
		...
		if prevRsi >= 8 && prevRsi < 14 && lastRsiChange > 5.8 {
			if prevAmplitude < 1.2 {
				if lowerShadowChangeRate > 0.6 {
					distanceRate = 0.115
					strategyPosition.Useable = 1
		...
		if prevRsi < 8 && lastRsiChange > 4 {
			if prevAmplitude < 1.2 {
				if lowerShadowChangeRate > 0.72 {
					distanceRate = 0.075
					strategyPosition.Useable = 1
				}
			} else if prevAmplitude > 1.2 && prevAmplitude < 2.1 {
				if lowerShadowChangeRate > 0.66 {
					distanceRate = 0.065
					strategyPosition.Useable = 1
				}
			} else if prevAmplitude > 2.1 && prevAmplitude < 4.0 {
				if lowerShadowChangeRate > 0.60 {
					distanceRate = 0.055
					strategyPosition.Useable = 1
				}
			} else {
				if lowerShadowChangeRate > 0.30 {
					distanceRate = 0.045
					strategyPosition.Useable = 1
				}
			}
