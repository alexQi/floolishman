...
type Emacross5m struct {
	BaseStrategy
}

func (s Emacross5m) SortScore() int {
	return StrategyScoresConst[s.Timeframe()]
}

func (s Emacross5m) GetPosition() types.StrategyPosition {
	return s.StrategyPosition
}

func (s Emacross5m) Timeframe() string {
	return "5m"
}

func (s Emacross5m) WarmupPeriod() int {
	return 30
}

func (s Emacross5m) Indicators(df *model.Dataframe) []types.ChartIndicator {
...
func (s *Emacross5m) OnCandle(df *model.Dataframe) {
