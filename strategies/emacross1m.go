...
type Emacross1m struct {
	BaseStrategy
}

func (s Emacross1m) SortScore() int {
	return StrategyScoresConst[s.Timeframe()]
}

func (s Emacross1m) GetPosition() types.StrategyPosition {
	return s.StrategyPosition
}

func (s Emacross1m) Timeframe() string {
	return "1m"
}

func (s Emacross1m) WarmupPeriod() int {
	return 60
}

func (s Emacross1m) Indicators(df *model.Dataframe) []types.ChartIndicator {
...
func (s *Emacross1m) OnCandle(df *model.Dataframe) {
